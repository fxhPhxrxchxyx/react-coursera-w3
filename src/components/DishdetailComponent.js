      ...
      <>
        <Modal isOpen={this.state.isOpen} toggle={() => this.onToggle()}>
            ...
            <Form>
              <FormGroup>
                ...
                <Input
                  type="number"
                  onChange={(e) =>
                    this.unControllFromInput("rating", e.target.value)
                  }
                  min={1}
                  max={5}
                  defaultValue={1}
              ...
              <FormGroup>
                ...
                <Input
                  invalid={this.validateForm() !== null}
                  valid={!this.validateForm()}
                  type="text"
                  onChange={(e) =>
                    this.unControllFromInput("name", e.target.value)
                  }
                />
              ...
              <FormGroup>
                ...
                <Input
                  ...
                  rows="6"
                  onChange={(e) =>
                    this.unControllFromInput("comment", e.target.value)
                  }
                />
              </FormGroup>
            </Form>
          ...
          <ModalFooter>
            <div style={{ width: "100%" }}>
              <Button
                className="btn-info mr-auto"
                disabled={this.validateForm() !== null}
        ...
        <Button outline className="mt-3" onClick={this.onToggle}>
